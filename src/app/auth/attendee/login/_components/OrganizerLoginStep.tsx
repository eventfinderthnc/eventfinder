...
export default function AttendeeLoginStep({
    onBack,
    onNext,
}: {
    onBack: () => void
    ...
    <div className="flex flex-col h-full justify-evenly gap-6">
      ...
      <div className="flex flex-col justify-between items-center gap-6 w-full">
        <Image src="/images/svg/attendee_auth.svg" alt="atten" width={170} height={170}/>
        <div className="flex flex-col justify-between items-center gap-6 w-full">
          <h1 className="text-[26px] font-semibold">ผู้เข้าร่วมกิจกรรม</h1>
