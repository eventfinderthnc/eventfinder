...
import { CreateInterestRequestSchema, UpdateInterestRequestSchema } from "../dto/interest.dto";
...
export const interestRouter = createTRPCRouter({
    create: protectedProcedure.input(CreateInterestRequestSchema).mutation(async ({ input }) => {
    ...
    update: protectedProcedure.input(UpdateInterestRequestSchema).mutation(async ({ input }) => {
